...
define config.name = _("El Cuenta Cuentos Ocelotl2")
...
define build.name = "ElCuentaCuentosOcelotl2"
...
define config.save_directory = "ElCuentaCuentosOcelotl2-1604735622"
